...
public class PHDTO {
    ...
    public PHDTO(String direccion, Double precio, boolean disponible, Operacion operacion, LocalDate fechaPublicacion, Integer dormitorios, Integer banios, Integer garage, Long area, Long tamanioLote) {
