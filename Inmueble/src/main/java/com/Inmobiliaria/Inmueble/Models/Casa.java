...
public class Casa {
    ...
    public Casa(String direccion, Double precio, boolean disponible, LocalDate fechaPublicacion, Operacion operacion, Integer dormitorios, Integer banios, Integer garage, Long area, Long tamanioLote) {
