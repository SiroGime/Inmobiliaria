...
public class PH{
    ...
    public PH(){};
    public PH(String direccion, Double precio, boolean disponible, LocalDate fechaPublicacion, Operacion operacion, Integer dormitorios, Integer banios, Integer garage, Long area, Long tamanioLote) {
